...
Game.prototype = {
  ...
  buildLevel: function() {
    ...
    for ( var i = 0; i < 500; i ++ ) {
      ...
      // add components
      var hoverComponent = this.engine.compManager.getComponentClassByName('hover')
      engine.compManager.instantiateComponent( hoverComponent, mesh )
      var spinnerComponent = this.engine.compManager.getComponentClassByName('spinner')
  ...
  defineComponents: function() {
    ...
    engine.compManager.registerComponentClass( solidComponent )
