...
Game.prototype = {
  ...
  setupControls: function() {
    ...
    this.transformControls = new THREE.TransformControls( engine.currentCamera, engine.renderer.domElement )
  ...
  switch (this.currentMode) {
    ...
    case 'play':
      ...
      // start carry
        ...
        if (target) {
          // var player = this.playerControls.getObject()
          var player = this.playerControls.getObject().children[0]
